...
namespace ChooseFood
{
	...
	void InitScreen() {
		...
		noodleButtonList[0] = button::DragDrop(Types::Noodle::FLAT, "납작면", 300, 600, 200, 200, Test);
		noodleButtonList[1] = button::DragDrop(Types::Noodle::MIDDLE, "기본면", 650, 700, 200, 200, Test);
		noodleButtonList[2] = button::DragDrop(Types::Noodle::SMALL, "소면", 1000, 600, 200, 200, Test);



		soupButtonList[0] = button::DragDrop(Types::Soup::MAULCHI, "멸치", 250, 600, 200, 200, Test);
		soupButtonList[1] = button::DragDrop(Types::Soup::DASIMA, "건다시마", 500, 600, 200, 200, Test);
		soupButtonList[2] = button::DragDrop(Types::Soup::TZUYU, "쯔유", 750, 600, 200, 200, Test);
		soupButtonList[3] = button::DragDrop(Types::Soup::MU, "무", 1000, 600, 200, 200, Test);

		decorationButtonList[0] = button::DragDrop(Types::Decoration::DAEPA, "대파", 250, 350, 200, 200, Test);
		decorationButtonList[1] = button::DragDrop(Types::Decoration::SICHIME, "대파", 500, 350, 200, 200, Test);
		decorationButtonList[2] = button::DragDrop(Types::Decoration::BANDALAMUK,"반달어묵", 750, 350, 200, 200, Test);
		decorationButtonList[3] = button::DragDrop(Types::Decoration::PYOGO, "표고버섯", 1000, 350, 200, 200, Test);
		decorationButtonList[4] = button::DragDrop(Types::Decoration::FIREMEET,"직화고기", 150, 550, 200, 200, Test);
		decorationButtonList[5] = button::DragDrop(Types::Decoration::GATHOBUSI, "가쓰오부시", 400, 550, 200, 200, Test);
		decorationButtonList[6] = button::DragDrop(Types::Decoration::YUBU, "썬유부", 650, 550, 200, 200, Test);
		decorationButtonList[7] = button::DragDrop(Types::Decoration::SUKK, "쑥갓", 900, 550, 200, 200, Test);
		decorationButtonList[8] = button::DragDrop(Types::Decoration::CHOUNGYANGGOCHU, "썬청양고추", 1150, 550, 200, 200, Test);
		decorationButtonList[9] = button::DragDrop(Types::Decoration::SUNKIM, "썬김(김채)", 150, 750, 200, 200, Test);
		decorationButtonList[10] = button::DragDrop(Types::Decoration::FLATAMUK, "납작어묵", 400, 750, 200, 200, Test);
		decorationButtonList[11] = button::DragDrop(Types::Decoration::SHRIMP, "새우튀김", 650, 750, 200, 200, Test);
		decorationButtonList[12] = button::DragDrop(Types::Decoration::FRYGARU,"튀김가루", 900, 750, 200, 200, Test);
		decorationButtonList[13] = button::DragDrop(Types::Decoration::SUNDAEPA,"썬대파", 1150, 750, 200, 200, Test);

		noodleInBasket[0] = button::DragDrop(Types::Basket::BASKET, "바구니", 1555, 180, 120, 120, basketfunction);
		for (int i = 0; i < 4; i++)
			soupInBasket[i] = button::DragDrop(Types::Basket::BASKET, "바구니", 1555, 180 + (i * 150), 120, 120, basketfunction);
		for (int i = 0; i < 8; i++)
			decorationInBasket[i] = button::DragDrop(Types::Basket::BASKET, "바구니", 1555, 180 + (i * 150), 120, 120, basketfunction);
	}
	//배경 이미지 그리기
	void ChooseScreen()
	{		
