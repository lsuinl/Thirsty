...
namespace ChooseFood
{
	...
	{
		button::Button("왼쪽",80,500,100,100, L"resource\\object\\leftPage.bmp",LeftPage),
		button::Button("오른쪽",1280, 500, 100, 100, L"resource\\object\\rightPage.bmp",RightPage),
		button::Button("위쪽",1500,100, 100, 100, L"resource\\object\\upPage.bmp",UpBasket),
		button::Button("아래쪽",1500, 900, 100, 100, L"resource\\object\\downPage.bmp",DownBasket),
		button::Button("완료",1650, 50, 200, 100, L"resource\\object\\clear.bmp",Selected),
	};

	button::DragDrop noodleButtonList[3] =
	{
		button::DragDrop("납작면",300,400, 300, 300, L"resource\\object\\noodle\\flat.bmp",Test),
		button::DragDrop("기본면",650, 600, 300, 300, L"resource\\object\\noodle\\middle.bmp", Test),
		button::DragDrop("소면",1000, 400, 300, 300, L"resource\\object\\noodle\\small.bmp", Test),
	};

	button::DragDrop soupButtonList[5] =
	{
		button::DragDrop("멸치",300,400, 200, 200, L"resource\\object\\soup\\maulchi.bmp",UpBasket),
		button::DragDrop("건다시마",380, 600, 200, 200, L"resource\\object\\soup\\dasima.bmp",DownBasket),
		button::DragDrop("쯔유",460, 400, 200, 200, L"resource\\object\\soup\\tzuyu.bmp",Selected),
		button::DragDrop("무",620, 400, 200, 200, L"resource\\object\\soup\\mu.bmp",Selected),
		button::DragDrop("가쓰오부시",940, 400, 200, 200, L"resource\\object\\soup\\gathobusi.bmp",Selected),
	};

	button::DragDrop decortaionButtonList[10] =
	{
		button::DragDrop("대파",300,400, 200, 200, L"resource\\object\\decoration\\daepa.bmp",UpBasket),
		button::DragDrop("시치미",380, 600, 200, 200, L"resource\\object\\decoration\\sichime.bmp",DownBasket),
		button::DragDrop("쪽파",460, 400, 200, 200, L"resource\\object\\decoration\\chupa.bmp",Selected),
		button::DragDrop("표고버섯",540, 600, 200, 200, L"resource\\object\\decoration\\pyogo.bmp",Selected),
		button::DragDrop("직화고기",700, 600, 200, 200, L"resource\\object\\decoration\\firemeet.bmp",Selected),
		button::DragDrop("썬유부",1000, 600, 200, 200, L"resource\\object\\decoration\\yubu.bmp",Selected),
		button::DragDrop("쑥갓",540, 200, 200, 200, L"resource\\object\\decoration\\sukk.bmp",Selected),
		button::DragDrop("썬김(김채)",1000, 200, 200, 200, L"resource\\object\\decoration\\sunkim.bmp",Selected),
		button::DragDrop("납작어묵",540, 800, 200, 200, L"resource\\object\\decoration\\flatamuk.bmp",Selected),
		button::DragDrop("새우튀김",700, 800, 200, 200, L"resource\\object\\decoration\\shirimp.bmp",Selected),
	};

	void ChooseScreen() 
	{
		//배경 이미지 그리기
		render::DrawBackGround("resource/background/minigame.bmp", 1920, 1080, 0, 0, false);
